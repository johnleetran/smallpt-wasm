...
### nodejs
em++ -g0 libsmallptwasm.a -o smallptwasm.js --bind -lnodefs.js -s "EXTRA_EXPORTED_RUNTIME_METHODS=['UTF8ToString']" -s ALLOW_MEMORY_GROWTH=1 -s MAXIMUM_MEMORY=4GB #--pre-js pre.js
